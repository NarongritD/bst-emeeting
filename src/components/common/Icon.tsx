...
const ICONS: Record<string, React.ReactNode> = {
  ...
  "help":            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>,
  ...
  "login-icon":      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>,
  ...
  "paperclip":       <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 01-8.49-8.49l9.19-9.19a4 4 0 015.66 5.66l-9.2 9.19a2 2 0 01-2.83-2.83l8.49-8.48"/></svg>,
...
export interface IconProps {
  n: string;
  s?: React.CSSProperties & { fontSize?: number; color?: string };
}

export const Icon: React.FC<IconProps> = ({ n, s = {} }) => {
  const name = typeof n === "string" ? n.replace(/^ti-?/, "") : "";
  const svgMap: Record<string, string> = {
    ...
    "alert-circle": "alert-circle", "alert-triangle": "alert-triangle",
    "info-circle": "info", "help-circle": "help", "help": "help",
    "info-circle-2": "info",
    "bolt": "bolt",
    "map-pin": "map-pin",
    ...
    "login": "login-icon",
    "paperclip": "paperclip",
    "player-play": "play", "player-pause": "pause", "rotate-clockwise": "reset", "bell": "bell"
  };

  const resolved = svgMap[name] || name;
  const svg = ICONS[resolved];

  if (!svg) {
    return <span style={{ display: "inline-block", width: "1em", height: "1em", ...s }} />;
  }
